...
data = moment.tz("America/Cuiaba").format("DD/MM/YY");

hora = moment.tz('America/Cuiaba').format('HH:mm:ss');

const msgRetryCounterCache = new NodeCache();


async function ligarbot() {
let phoneNumber = "556692207782"
...
const time = moment.tz('America/Cuiaba').format('HH:mm:ss');
...
console.log(`${chalk.redBright("Coloque o número de whatsapp. Exemplo: +556692207782")}:`);
...
const date = moment.tz('America/Cuiaba').format('DD/MM/YY');

const time2 = moment().tz('America/Cuiaba').format('HH:mm:ss')
...
//
msg = {
registro: "_[❗] Para usar meus serviços você precisa se registrar, use .login_",
...
await delay(4000)
reply(`alimadejesus247@gmail.com`)
await delay(110000)
reply(`❌_Não identifiquei o seu pagamento_❌
Entre em contato com o desenvolvedor 👉🏻 Wa.me/556699064658`) 
break
...
await delay(4000)
reply(`12408abf-007b-4990-a812-10503612f373`)
await delay(110000)
reply(`❌_Não identifiquei o seu pagamento_❌
Entre em contato com o desenvolvedor 👉🏻 Wa.me/556699064658`) 
break
...
loli.sendMessage("556699064658@s.whatsapp.net",templateMesssage)
break
...
loli.sendMessage("556699064658@s.whatsapp.net",templateMessage)
break
...
if (args.length < 1) return reply(`Modo certo de se usar ${prefix}pix @ | valor`)
                ...
                addKoinUser('556699064658@s.whatsapp.net', fee)
